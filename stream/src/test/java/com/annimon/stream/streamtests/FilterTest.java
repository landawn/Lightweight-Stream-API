...
public final class FilterTest {
    ...
    //        IntStream.range(0, 10).boxed().filter(Functions.remainder(2)).__(assertElements(contains(0, 2, 4, 6, 8)));
    //    }
    //
    ...
    //        IntStream.range(0, 10).boxed().filter(predicate).__(assertElements(contains(0, 2, 3, 4, 6, 8, 9)));
    //    }
    //
    //    @Test
    ...
    //        IntStream.range(0, 10).boxed().filter(predicate).__(assertElements(contains(0, 6)));
    //    }
    //
    //    @Test
    ...
    //        IntStream.range(0, 10).boxed().filter(predicate).__(assertElements(contains(2, 3, 4, 8, 9)));
    //    }
}
